...
namespace SoloDevApp.Api.Controllers
{
    ...
    public class BinhLuanController : ControllerBase
    {
       ...
       [HttpGet]
        ...
        [HttpGet("lay-binh-luan-theo-phong/{MaPhong}")]
        public async Task<IActionResult> GetBinhLuanTheoCongViec(string MaPhong)
        {

            return await _binhLuanService.GetBinhLuanTheoPhong(MaPhong);
        }
