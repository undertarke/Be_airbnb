...
namespace SoloDevApp.Service.Services
{
    ...
    {
         Task<ResponseEntity> GetBinhLuanTheoPhong(string MaPhong);
    ...
    public class BinhLuanService : ServiceBase<BinhLuan, BinhLuanViewModel>, IBinhLuanService
    {
        ...
        public async Task<ResponseEntity> GetBinhLuanTheoPhong(string maPhong)
        {
            try
            {
                IEnumerable<BinhLuan> dsBinhLuan = await _binhLuanRepository.GetMultiByConditionAsync("MaPhong", maPhong);
